...
| 典型应用场景 | [应用的跳转与拉起](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-web-app-jump-and-pull-up)[请求重定向](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-web-interceptor#section103591931490)[页面白名单配置](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-web-interceptor#section1367693510110) | [本地资源替换](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-web-interceptor#section29637307122)[自定义资源加载策略](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-web-interceptor#section766911191316)提示恶意请求 | 除支持onInterceptRequest的应用场景外，还支持： [配置公共请求头](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-web-interceptor#section736313281410)跨域请求POST请求拦截 |
...
**图1** 基于onLoadIntercept()的请求拦截流程图  ![](../assets/0003-Web组件拦截能力的使用-bpta-web-interceptor-image-001.png "点击放大")
...
**图2** 请求重定向  ![](../assets/0003-Web组件拦截能力的使用-bpta-web-interceptor-image-002.png "点击放大")
...
**图3** 页面白名单配置  ![](../assets/0003-Web组件拦截能力的使用-bpta-web-interceptor-image-003.png "点击放大")
...
**图4** 基于onInterceptRequest()的请求拦截流程图  ![](../assets/0003-Web组件拦截能力的使用-bpta-web-interceptor-image-004.png "点击放大")
...
**图5** 本地资源替换  ![](../assets/0003-Web组件拦截能力的使用-bpta-web-interceptor-image-005.png "点击放大")
...
**图6** Wi-Fi网络环境下加载图片资源  ![](../assets/0003-Web组件拦截能力的使用-bpta-web-interceptor-image-006.png "点击放大")



**图7** 非Wi-Fi网络环境下加载本地占位图  ![](../assets/0003-Web组件拦截能力的使用-bpta-web-interceptor-image-007.png "点击放大")
...
**图8** 基于WebSchemeHandler的请求拦截流程图  ![](../assets/0003-Web组件拦截能力的使用-bpta-web-interceptor-image-008.png "点击放大")
...
**图9** 配置公共请求头  ![](../assets/0003-Web组件拦截能力的使用-bpta-web-interceptor-image-009.png "点击放大")
