...
**图1** 反例标签"H:ScrollSlide"Trace图  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-001.png "点击放大")
...
**图2** 案例一onWillScroll事件回调耗时  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-002.png "点击放大")



**图3** 案例二onWillScroll事件回调耗时  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-003.png "点击放大")
...
**图4** onWillScroll执行耗时操作的丢帧率  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-004.png "点击放大")



**图5** onWillScroll不执行耗时操作的丢帧率  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-005.png "点击放大")



**图6** 首帧Trace详细信息  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-006.png "点击放大")
...
**图7** 反例滑动时单个aboutToReuse耗时  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-007.png "点击放大")



**图8** 正例滑动时单个aboutToReuse耗时  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-008.png "点击放大")
...
**图9** itemGenerator中执行耗时操作的滑动效果  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-009.gif)



**图10** itemGenerator中不执行耗时操作的滑动效果  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-010.gif)
...
**图11** 通过资源对象获取数据的耗时  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-011.png "点击放大")



**图12** 通过资源id获取数据的耗时  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-012.png "点击放大")
...
**图13** 不使用多线程的Trace信息  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-013.png "点击放大")
...
**图14** 使用多线程的Trace信息  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-014.png "点击放大")
...
**图15** 主线程反序列化耗时  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-015.png "点击放大")
...
**图16** 使用@Sendable装饰器后主线程反序列化耗时  ![](../assets/0041-主线程耗时操作优化-bpta-time-optimization-of-the-main-thread-image-016.png "点击放大")
