...
**图1** 没有提前加载数据的打点信息  ![](../assets/0046-Swiper组件加载丢帧优化-bpta-swiper_high_performance_development_guide-image-001.png "点击放大")
...
**图2** 使用了提前加载数据的打点信息  ![](../assets/0046-Swiper组件加载丢帧优化-bpta-swiper_high_performance_development_guide-image-002.png "点击放大")
...
**图3** “H:noPreLoadData”时间段的trace详细信息  ![](../assets/0046-Swiper组件加载丢帧优化-bpta-swiper_high_performance_development_guide-image-003.png "点击放大")
