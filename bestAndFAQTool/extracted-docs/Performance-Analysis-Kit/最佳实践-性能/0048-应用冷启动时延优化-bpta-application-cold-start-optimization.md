...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-001.png "点击放大")
...
1. 选择entry模块，暂时关闭模块build-profile中的混淆开关。     ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-002.png "点击放大")

2. 检查一下build模式，改为release。     ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-003.png)

3. 点击菜单 -> tool -> AppAnalyzer，打开体检工具。

4. 选择“场景化体检”，点击“手动性能冷启动体检”。     工具开始准备，会自动编译、安装、运行当前工程，此时需要“保持手机解锁状态”，当准备完成后，会提示点击开始按钮，开始体检。

     ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-004.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-005.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-006.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-007.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-008.png "点击放大")
...
1. 查找耗时最高的未使用import文件。     在本地浏览器中打开下载的依赖关系的文件full_dependency.html，视图中左侧列表表示已加载未使用的文件，并且按照耗时从高到低排序；右侧表示已使用文件，开发者需要关注未使用文件中耗时较多的几个文件导入，例如DetailView文件的导入。
     ...
     ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-009.png "点击放大")

2. 根据文件名检索文件调用关系链。     在搜索框中通过文件名DetailView进行检索，该文件的依赖关系则会在下方节点视图中展示，并且默认会展示其子节点的使用情况，未使用的文件会被标红显示。

     ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-010.png "点击放大")

3. 查看检索文件的上层和下层文件节点信息。     查找上层文件节点信息，即目标文件被导入的位置；查找下层文件节点信息，目标文件的耗时是否由其子节点导致，如果下层文件耗时较长，则需要考虑优化子节点的导入。

     ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-011.png "点击放大")
...
```
  ...
  - 如果上层文件为其他module的统一对外暴露接口文件（例如Index.ets），则需要通过import路径展开性能优化。         例如CustomLayout1上层模块为library模块的Index.ets，其中有多个文件导出。
         ...
         ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-012.png "点击放大")
...
5. 在导出文件中标记已修改的文件。     在下载全量import文件清单表格中，标记已优化的未使用文件，便于优化备忘，特别是当需要优化的文件比较多的时候。
     ...
     ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-013.png "点击放大")
...
- 网络请求本身耗时长     ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-014.png "点击放大")
...
- 网络请求发起太晚     ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-015.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-016.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-017.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-018.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-019.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-020.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-021.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-022.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-023.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-024.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-025.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-026.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-027.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-028.png "点击放大")
 ...
 **图4** 优化网络请求时机前   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-029.png "点击放大")



 **图5** 优化网络请求时机后   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-030.png "点击放大")
...
| <br>方案 | <br>阶段时长(毫秒) |
| --- | --- |
| <br>优化网络请求时机前 | <br>1700 |
| <br>优化网络请求时机后 | <br>885.3 |
 ...
 **图6** 优化前使用4096px-4096px启动页图标应用启动耗时   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-031.png)



 **图7** 优化后使用144px-144px启动页图标应用启动耗时   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-032.png)
 ...
 **图8** 优化前import 15个模块   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-033.png "点击放大")



 **图9** 优化后import 5个模块   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-034.png "点击放大")
...
| <br>方案 | <br>阶段时长(微秒) |
| --- | --- |
| <br>减少import的模块前 | <br>6239.5 |
| <br>减少import的模块后 | <br>119.7 |
...
- 减少使用嵌套的export *方式进行全量导出     在应用冷启动过程中，`HandleLaunchAbility` 会执行冷启动相关的 `.ets` 文件。所有被主页面import的 `.ets` 文件均会被执行，包括数据结构、变量和全局函数的初始化。首页所需的变量和函数可能来自其他 `.ets` 文件，并通过export形式提供给首页使用。详细信息请参见[减少同文件大量export *导出方式](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-arkts-high-performance#section1218510102815)。
   ...
   **图10** （优化前）存在8层嵌套export *   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-035.png "点击放大")

   **图11** （优化后）不存在嵌套export *，从目标文件中直接import   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-036.png "点击放大")
     对比数据如下：
  ...
  展开
    | <br>方案 | <br>阶段时长(微秒) |
    | --- | --- |
    | <br>（优化前）存在8层嵌套export * | <br>492.6 |
    | <br>（优化后）不存在嵌套export *，从目标文件中直接import | <br>388.7 |
...
- 减少import *的方式全量引用     应用程序加载时，通常将相同类型的变量或函数放在同一个工具类文件中。使用时，通过import方式引入对应的模块。当工具类中存在较多暴露的函数或变量时，推荐按需引用具体的变量，以减少 `.ets` 文件的执行耗时和文件中所有export变量的初始化过程。详情请参见[减少同文件大量export *导出方式](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-arkts-high-performance#section1218510102815)。
   ...
   **图12** 优化前，使用import * as nm全量引用2000条数据   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-037.png "点击放大")

   **图13** 优化后，使用import { One }按需引用   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-038.png "点击放大")
     优化前后的对比数据如下：
  ...
  展开
    | <br>方案 | <br>阶段时长(毫秒) |
    | --- | --- |
    | <br>（优化前）使用import * as nm全量引用 | <br>16.7 |
    | <br>（优化后）使用import { One }按需引用 | <br>7.1 |
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-039.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-040.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-041.png "点击放大")
 ...
 **图17** 优化前：加载模块时执行了非冷启动相关文件   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-042.png "点击放大")



 **图18** 优化方案一：拆分HAR导出文件   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-043.png "点击放大")



 **图19** 优化方案二：导入冷启动文件时全路径展开   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-044.png "点击放大")
...
| --- | --- |
| <br>优化前 | <br>140.1 |
| <br>优化方案一（拆分HAR导出文件） | <br>62.9 |
| <br>优化方案二（导入冷启动文件时全路径展开） | <br>61.3 |
 ...
 **图20** HAP+20个HSP混合打包   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-045.png "点击放大")



 **图21** 将20个HSP包设计成HAR包   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-046.png "点击放大")
...
| <br>方案 | <br>阶段时长(微秒) |
| --- | --- |
| <br>HAP+20个HSP混合打包 | <br>34643.7 |
| <br>将20个HSP包设计成HAR包 | <br>36.4 |
 ...
 **图22** 优化前同步执行操作（computeTask），应用冷启动耗时   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-047.png)



 **图23** 优化后异步执行操作（computeTaskAsync），应用冷启动耗时   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-048.png)
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-049.png "点击放大")
 ...
 **图25** 优化前同步执行操作（computeTask），应用冷启动耗时   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-050.png)



 **图26** 优化后异步执行操作（computeTaskAsync），应用冷启动耗时   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-051.png)
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-052.png "点击放大")
 ...
 **图28** 优化前同步执行操作（computeTask），应用冷启动耗时   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-053.png)



 **图29** 优化后异步执行操作（computeTaskAsync），应用冷启动耗时   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-054.png "点击放大")
...
![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-055.png "点击放大")
 ...
 **图31** 优化前未使用本地存储数据   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-056.png "点击放大")



 **图32** 优化后使用本地存储数据   ![](../assets/0048-应用冷启动时延优化-bpta-application-cold-start-optimization-image-057.png "点击放大")
...
| <br>方案 | <br>阶段时长(毫秒) |
| --- | --- |
| <br>（优化前）未使用本地存储 | <br>641.8 |
| <br>（优化后）使用本地存储 | <br>68.9 |
