...
![](../assets/0038-组件嵌套优化-bpta-component-nesting-optimization-image-001.png "点击放大")
...
![](../assets/0038-组件嵌套优化-bpta-component-nesting-optimization-image-002.png "点击放大")
...
通过DevEco Studio内置ArkUI Inspector工具，查看组件树结构可以看到，相比使用@Builder方法，组件树多一个自定义组件节点，所以[优先使用@Builder方法代替自定义组件](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-component-nesting-optimization#section1012953161217)减少了自定义组件节点数量。而给自定义组件添加属性，会在自定义组件外部会创建一个“__Common__”类型的节点，如下图所示。为了避免这类“__Common__”节点的创建，可以将自定义组件的属性移至内部，或者动态设置自定义组件的属性。减少自定义组件产生多余节点，可以使总节点数量降低，从而提升性能。



**图1** 自定义组件树变化示意图  ![](../assets/0038-组件嵌套优化-bpta-component-nesting-optimization-image-003.png "点击放大")
...
**图2** 使用组件属性代替嵌套组件示意图  ![](../assets/0038-组件嵌套优化-bpta-component-nesting-optimization-image-004.png "点击放大")
...
使用overlay属性可以直接给组件添加浮层，实现堆叠的效果，常见的场景有文本浮层、按压遮罩等。相较于Stack布局嵌套组件的方式，使用overlay属性减少了Stack组件节点的创建。以增加文本浮层为例，具体优化示例如下所示。更多使用overlay属性实现浮层场景的示例可参考[浮层-示例](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-overlay#%E7%A4%BA%E4%BE%8B)。
