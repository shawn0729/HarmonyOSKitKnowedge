...
**图1** 场景动画  ![](../assets/0014-Web点击响应时延分析-bpta-web-click-response-delay-analysis-image-001.gif "点击放大")
...
![](../assets/0014-Web点击响应时延分析-bpta-web-click-response-delay-analysis-image-002.png "点击放大")
...
1. 确认起点：如果是由点击触发，则首先定位到应用侧的DispatchTouchEvent，如下图虚线所示：
  **图3** Trace起点     ![](../assets/0014-Web点击响应时延分析-bpta-web-click-response-delay-analysis-image-003.png "点击放大")
...
2. 确认终点：选择连续稳定发出的第一帧vsync信号作为终点，而非不稳定vsync信号，是因为非连续的vsync信号不一定触发界面上的渲染行为。本文旨在分析从应用元素点击到应用界面开始变化的点击时延问题，因此选择连续稳定渲染的第一帧vsync信号作为终点。
  **图4** Trace终点     ![](../assets/0014-Web点击响应时延分析-bpta-web-click-response-delay-analysis-image-004.png "点击放大")

     从图中可以看出，后续动画已经达到最大帧率，说明无响应发生在图中区域内。

3. 分析中途出现的H:ReceiveVsync信号可以发现，在无响应阶段出现了几帧，但每帧的耗时并不长。应用侧也是如此，说明在UI绘制过程中没有高负载。
  **图5** Trace帧率分析     ![](../assets/0014-Web点击响应时延分析-bpta-web-click-response-delay-analysis-image-005.png "点击放大")

4. 在此过程中，应用长时间占用CPU，原因可能是进行了大量的计算。
  **图6** 可能耗时原因
     ![](../assets/0014-Web点击响应时延分析-bpta-web-click-response-delay-analysis-image-006.png "点击放大")
...
**图7** DevTools泳道图区域划分  ![](../assets/0014-Web点击响应时延分析-bpta-web-click-response-delay-analysis-image-007.png "点击放大")
...
**图8** DevTools泳道图区域划分  ![](../assets/0014-Web点击响应时延分析-bpta-web-click-response-delay-analysis-image-008.png "点击放大")
...
**图9** DevTools泳道图区域划分  ![](../assets/0014-Web点击响应时延分析-bpta-web-click-response-delay-analysis-image-009.png "点击放大")
...
**图10** DevTools泳道图区域划分  ![](../assets/0014-Web点击响应时延分析-bpta-web-click-response-delay-analysis-image-010.png "点击放大")
...
![](../assets/0014-Web点击响应时延分析-bpta-web-click-response-delay-analysis-image-011.png "点击放大")
...
**图12** DevTools泳道图区域划分  ![](../assets/0014-Web点击响应时延分析-bpta-web-click-response-delay-analysis-image-012.png "点击放大")
...
**图13** DevTools泳道图区域划分  ![](../assets/0014-Web点击响应时延分析-bpta-web-click-response-delay-analysis-image-013.png "点击放大")
...
**图14** DevTools泳道图区域划分  ![](../assets/0014-Web点击响应时延分析-bpta-web-click-response-delay-analysis-image-014.png "点击放大")
...
**图15** 优化后的泳道图  ![](../assets/0014-Web点击响应时延分析-bpta-web-click-response-delay-analysis-image-015.png "点击放大")
