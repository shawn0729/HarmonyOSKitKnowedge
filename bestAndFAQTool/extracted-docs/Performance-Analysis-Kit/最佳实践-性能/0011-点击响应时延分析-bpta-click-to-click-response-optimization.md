 ...
 **图1** 点击响应起止点示意图   ![](../assets/0011-点击响应时延分析-bpta-click-to-click-response-optimization-image-001.png "点击放大")
...
![](../assets/0011-点击响应时延分析-bpta-click-to-click-response-optimization-image-002.png "点击放大")
...
2. 点击“手动性能页面间转场体检”按钮启动检测。  
     ...
     ![](../assets/0011-点击响应时延分析-bpta-click-to-click-response-optimization-image-003.png "点击放大")

  

3. 开发者需根据提示，在应用中找到待检测页面，点击工具中的开始按钮，然后在应用中手动执行转场，操作后点击停止完成本次检测。  

     ![](../assets/0011-点击响应时延分析-bpta-click-to-click-response-optimization-image-004.png "点击放大")

  

4. 检测结果分析，点击响应时延应小于或等于100ms。图中存在大于100ms的点击响应时延，判断为存在性能问题。  

     ![](../assets/0011-点击响应时延分析-bpta-click-to-click-response-optimization-image-005.png "点击放大")
...
1. 获得检测结果后，点击详情报告中的“点击响应时延”，可以查看UI线程应用自身方法耗时长的检测结果。  
     ...
     ![](../assets/0011-点击响应时延分析-bpta-click-to-click-response-optimization-image-006.png "点击放大")
...
1. 获得检测结果后，点击详情报告中的“点击响应时延”，可以查看UI线程应用自定义组件创建耗时检测结果。  
     ...
     ![](../assets/0011-点击响应时延分析-bpta-click-to-click-response-optimization-image-007.png "点击放大")

  

2. 可点击源文件定位到创建耗时的UI组件，根据提供的可能故障原因，去对UI组件进行相应优化修改，减少该UI组件自身创建耗时。  

     ![](../assets/0011-点击响应时延分析-bpta-click-to-click-response-optimization-image-008.png "点击放大")
...
1. 抓取操作trace：启动DevEco Studio，连接设备，打开应用，执行以下操作。  
  ...
  5. 点击Frame模板框中的播放按钮开始录制，操作应用界面进行点击响应，完成后点击结束录制。
     ...
     ![](../assets/0011-点击响应时延分析-bpta-click-to-click-response-optimization-image-009.png "点击放大")
...
3. 分解时间段：点击响应的整体时延拆解后，主要分为输入阶段、应用阶段和渲染阶段。  
  ...
  展开
    | <br>首帧响应时延 | <br>起点 | <br>终点 | <br>基线(ms) |
    | --- | --- | --- | --- |
    | <br>输入阶段 | <br>mmi_service对应的service report(type为up) | <br>应用DispatchTouchEvent的起点(type=1) | <br>8 |
    | <br>应用阶段 | <br>应用DispatchTouchEvent的起点(type=1) | <br>页面首次发生变化帧对应的H:FlushMessage结束点 | <br>25 |
    | <br>渲染阶段 | <br>对应的RS帧ProcessCommandUni起点 | <br>对应的RSHardwareThread::CommitAndReleaseLayers的结束点 | <br>20 |
     应用阶段（如下图中标记2与3之间的部分）是开发者需要优化的部分。若应用阶段耗时超过25ms，加上机器硬件30ms的耗时，整体时延可能超过100ms，导致点击响应体验不佳，需定位性能问题。

     ![](../assets/0011-点击响应时延分析-bpta-click-to-click-response-optimization-image-010.png "点击放大")
...
4. 分析定位原因：针对框选的应用阶段，分析主进程泳道，观察是否存在耗时长的函数阻塞主线程或超长耗时单帧。如果有长段的ExecuteJs，查看具体的调用栈或火焰图，定位耗时函数。如果是FlushLayoutTask阶段耗时，结合UI组件树分析布局合理性，查找优化空间。  
     ...
     ![](../assets/0011-点击响应时延分析-bpta-click-to-click-response-optimization-image-011.png "点击放大")
 ...
 **图3** renderGroup使用场景示例   ![](../assets/0011-点击响应时延分析-bpta-click-to-click-response-optimization-image-012.gif)
 ...
 **图4** 生命周期流程图   ![](../assets/0011-点击响应时延分析-bpta-click-to-click-response-optimization-image-013.png "点击放大")
 ...
 **图5** 应用响应的两个视角   ![](../assets/0011-点击响应时延分析-bpta-click-to-click-response-optimization-image-014.png)
