...
1. 打开示例应用，运行 hdc shell "hidumper -s WindowManagerService -a '-a'"获取到当前应用的pid。  
    ...
    ![](../assets/0019-获取进程内存信息-bpta-retrieve-process-memory-info-image-001.png "点击放大")
...
![](../assets/0019-获取进程内存信息-bpta-retrieve-process-memory-info-image-002.png "点击放大")



## 通过代码获取应用内存信息

开发者可使用[@ohos.hidebug (Debug调试)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-hidebug)接口获取应用进程的内存信息，使用指导详见[获取内存信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hidebug-guidelines#%E8%8E%B7%E5%8F%96%E5%86%85%E5%AD%98%E4%BF%A1%E6%81%AF)。
