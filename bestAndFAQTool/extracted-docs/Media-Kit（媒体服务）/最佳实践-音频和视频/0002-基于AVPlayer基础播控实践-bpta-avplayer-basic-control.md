...
| 场景名称 | 描述 | 实现方案 |
| --- | --- | --- |
| [基础播控](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-avplayer-basic-control#section169581112135319) | 视频资源的加载、播放、暂停、退出等操作。 | 使用[AVPlayer接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avplayer)实现。 |
| [跳转播放](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-avplayer-basic-control#section1897734041617) | 滑动进度条精准跳转到指定时间进行播放。 | 使用[Slider组件](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-slider)实现进度条，在其onChange回调中触发进度调节。 |
| [静音播放](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-avplayer-basic-control#section15152110181715) | 点击按钮设置静音播放。 | 使用AVPlayer的[setMediaMuted()方法](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avplayer#setmediamuted12)控制静音状态。 |
| [循环播放](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-avplayer-basic-control#section09619253174) | 视频播放结束后会从初始位置再次播放。 | 通过在prepared状态下，设置视频播放器AVPlayer的[loop属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avplayer#%E5%B1%9E%E6%80%A7)值为true，实现视频循环播放。 |
| [窗口缩放模式设置](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-avplayer-basic-control#section18974144910175) | 设置窗口缩放模式体验不同的缩放效果。 | 通过设置AVPlayer的[videoScaleType属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-e#videoscaletype9)设置窗口缩放模式。 |
| [倍速设置](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-avplayer-basic-control#section1333481316184) | 可以通过[点击按钮选择倍速](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-avplayer-basic-control#section1333481316184)或者通过[长按手势调节倍速](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-avplayer-basic-control#section364983943913)。 | 使用AVPlayer的[setSpeed()方法](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avplayer#setspeed9)设置倍速。通过添加按钮和弹窗实现通过按钮调节倍速；通过给组件绑定[长按手势](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-gestures-longpressgesture)实现长按倍速。 |
| [音量设置](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-avplayer-basic-control#section74003157187) | 可以滑动屏幕调节音量。 | 使用[AVVolumePanel组件](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ohos-multimedia-avvolumepanel)显示音量，通过给组件绑定[手势滑动监听](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-gestures-pangesture)实现调节音量。 |
| [字幕挂载与切换](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-avplayer-basic-control#section627701016296) | 视频下方显示字幕。 | 使用AVPlayer的[addSubtitleFromFd()方法](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avplayer#addsubtitlefromfd12)设置外挂字幕资源，并通过AVPlayer实例注册字幕回调函数[on('subtitleUpdate')](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avplayer#onsubtitleupdate12)；通过切换字幕资源并使用AVPlayer的[reset()方法](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avplayer#reset9-1)重置播放实现切换字幕。 |
...
![](../assets/0002-基于AVPlayer基础播控实践-bpta-avplayer-basic-control-image-001.gif "点击放大")
...
![](../assets/0002-基于AVPlayer基础播控实践-bpta-avplayer-basic-control-image-002.gif "点击放大")
...
在视频prepared状态下，设置视频播放器AVPlayer的[loop属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avplayer#%E5%B1%9E%E6%80%A7)值为true，实现视频循环播放。
...
**图1** 拉伸至与窗口等大模式  ![](../assets/0002-基于AVPlayer基础播控实践-bpta-avplayer-basic-control-image-003.gif "点击放大")



**图2** 缩放至最短边填满窗口  ![](../assets/0002-基于AVPlayer基础播控实践-bpta-avplayer-basic-control-image-004.gif "点击放大")
...
![](../assets/0002-基于AVPlayer基础播控实践-bpta-avplayer-basic-control-image-005.gif "点击放大")
...
![](../assets/0002-基于AVPlayer基础播控实践-bpta-avplayer-basic-control-image-006.gif "点击放大")
...
![](../assets/0002-基于AVPlayer基础播控实践-bpta-avplayer-basic-control-image-007.gif "点击放大")
