...
| 类型 | 代表格式 | 播放能力支持 | 特点 |
| --- | --- | --- | --- |
| 未压缩 | PCM/WAV | PCM：AudioRenderer<br>WAV：AVPlayer | 高保真、体积大 |
...
![](../assets/0034-音质切换开发实践-bpta-sound-quality-switching-image-001.gif "点击放大")
...
![](../assets/0034-音质切换开发实践-bpta-sound-quality-switching-image-002.gif "点击放大")
