...
![](../assets/0018-基于AVRecorder录制格式化音频（ArkTS）-bpta-audio-record-base-on-avrecorder-arkts-image-001.gif "点击放大")
...
![](../assets/0018-基于AVRecorder录制格式化音频（ArkTS）-bpta-audio-record-base-on-avrecorder-arkts-image-002.png "点击放大")
