...
![](../assets/0004-基于AVPlayer播放短视频实践-bpta-avplayer-short-video-image-001.gif "点击放大")
...
![](../assets/0004-基于AVPlayer播放短视频实践-bpta-avplayer-short-video-image-002.png "点击放大")
...
![](../assets/0004-基于AVPlayer播放短视频实践-bpta-avplayer-short-video-image-003.gif "点击放大")
...
1. 数据懒加载     冷启动时创建第一个播放器，播放当前视频时预加载下一个视频（预加载会增加用户流量消耗，需开发者自行决策）。使用XComponent的Surface类型动态渲染视频流，LazyForEach进行数据懒加载。

2. 异步在线视频预加载     在轮播过程中，对下一个视频提前进入AVPlayer的prepared状态。

3. 在线视频播放预加载     滑动过程中，手指离开屏幕时，滑动动效开始播放。此时，可以调用AVPlayer的play方法进行播放。
...
![](../assets/0004-基于AVPlayer播放短视频实践-bpta-avplayer-short-video-image-004.png "点击放大")
...
![](../assets/0004-基于AVPlayer播放短视频实践-bpta-avplayer-short-video-image-005.png "点击放大")
