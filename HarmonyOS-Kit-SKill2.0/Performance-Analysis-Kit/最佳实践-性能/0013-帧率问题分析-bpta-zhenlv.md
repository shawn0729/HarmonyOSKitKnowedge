...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-001.png "点击放大")
 ...
 **图2** ArkUI渲染管线结构与Frame Insight性能打点   ![](../assets/0013-帧率问题分析-bpta-zhenlv-image-002.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-003.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-004.png "点击放大")
 ...
 **图5** 丢帧问题处理流程   ![](../assets/0013-帧率问题分析-bpta-zhenlv-image-005.png)
...
本文以“[HMOS世界](https://gitcode.com/harmonyos_samples/hmosworld#hmos%E4%B8%96%E7%95%8C)”应用的首页列表为例，介绍通过Frame分析、定位和解决卡顿问题的全过程。为了便于演示，列表初始加载了1000条数据。
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-006.png "点击放大")
...
1. 在DevEco Studio中启动AppAnalyzer工具，详细请参考：[AppAnalyzer](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-performance-detection#section135451444171)。  
     ...
     ![](../assets/0013-帧率问题分析-bpta-zhenlv-image-007.png "点击放大")
...
2. 执行滑动场景体检。选择场景化体检，然后点击“手动性能页面滑动体检”，工具会进行准备，自动编译、安装、运行当前工程，需要保持手机解锁状态。  
  ...
  1. 当提示“准备完成，请操作手机至检测页面”等内容时，需要在手机应用中找到待检测的滑动页面，然后点击开始按钮。         ![](../assets/0013-帧率问题分析-bpta-zhenlv-image-008.png "点击放大")

  2. 等待工具录制准备，当提示“体检中，请操作手机”时，在手机上的待检测页面执行滑动若干次。等待剩余时间结束或点击暂停按钮，再点击停止完成本次检测。         ![](../assets/0013-帧率问题分析-bpta-zhenlv-image-009.png "点击放大")

  

3. 生成性能体检报告。工具分析后，若检测未通过如下所示。  

     ![](../assets/0013-帧率问题分析-bpta-zhenlv-image-010.png "点击放大")
...
- 如果函数的单次调用耗时长（查看平均耗时），说明是函数本身耗时长，开发者自行优化函数，将函数放到子线程或者进行缓存，开发者可参考[其他主线程优化思路](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-time-optimization-of-the-main-thread#section4365993361)。     ![](../assets/0013-帧率问题分析-bpta-zhenlv-image-011.png "点击放大")

- 如果函数本身耗时不长，但是函数调用次数多（例如在高频回调里打日志等操作）     ![](../assets/0013-帧率问题分析-bpta-zhenlv-image-012.png "点击放大")
...
- 如果方法名aboutToBeDeleted调用次数过多，如下图所示：     ![](../assets/0013-帧率问题分析-bpta-zhenlv-image-013.png "点击放大")

     此时需要点击**总耗时**列的超链接，打开trace向前排查主线程是否有阻塞。如下图所示也是因为前面的主线程阻塞导致的，因为destroy只会发生在idle，如果主线程阻塞一直没有idle，就会积压；

     ![](../assets/0013-帧率问题分析-bpta-zhenlv-image-014.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-015.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-016.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-017.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-018.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-019.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-020.png "点击放大")
 ...
 **图7** 丢帧处应用主线程状态   ![](../assets/0013-帧率问题分析-bpta-zhenlv-image-021.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-022.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-023.png "点击放大")



接下来通过Trace查看每一帧的具体耗时，点击![](../assets/0013-帧率问题分析-bpta-zhenlv-image-024.png)图标跳转到卡顿帧应用侧Trace详情，如下图所示。开发者，可以点击泳道信息区的收藏按钮，将应用帧处理的泳道收藏置顶，防止上下文信息丢失。



![](../assets/0013-帧率问题分析-bpta-zhenlv-image-025.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-026.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-027.png)
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-028.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-029.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-030.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-031.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-032.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-033.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-034.png "点击放大")
...
![](../assets/0013-帧率问题分析-bpta-zhenlv-image-035.png "点击放大")
