...
![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-001.png "点击放大")



**图2** 页面转场过程解析  ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-002.png "点击放大")
...
![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-003.png "点击放大")
...
2. 点击“手动性能页面间转场体检”按钮启动检测。  
    ...
    ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-004.png "点击放大")

  

3. 开发者需根据提示，在应用中找到待检测页面，点击工具中的开始按钮，然后在应用中手动执行转场，操作后点击停止完成本次检测。  

    ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-005.png "点击放大")

  

4. 检测结果分析，点击完成时延应小于或等于900ms。如果存在大于900ms的点击完成时延，判断为存在性能问题。  

    ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-006.png)
...
1. 获得检测结果后，点击详情报告中的“点击完成时延”，可以查看UI线程应用自身方法耗时长的检测结果。  
    ...
    ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-007.png "点击放大")
...
1. 获得检测结果。点击详情报告中的“点击完成时延”，可以查看UI线程应用自定义组件创建耗时检测结果。  
    ...
    ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-008.png "点击放大")
...
2. 点击源文件定位到创建耗时的UI组件，根据提供的可能故障原因，对UI组件进行相应的优化，还可参考静态检测结果中的优化建议，来对组件创建耗时进行优化。  
    ...
    ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-009.png "点击放大")
...
2. 根据检测结果中的请求耗时和点击离手到请求发起间隔可进行如下判断。  
  ...
  - 网络请求本身耗时长         ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-010.png "点击放大")
  ...
  - 网络请求发起太晚         ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-011.png "点击放大")
...
1. 获得检测结果。点击详情报告中的“阻塞主线程的任务”，可以查看主线程长时间被阻塞的检测结果。  
    ...
    ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-012.png "点击放大")
...
2. 可能存在以下5种诊断结果。  
  ...
  - 子线程中耗时函数执行         点击子线程中函数执行链接，跳转至子线程中耗时函数执行的源码，可发现主线程中的UI刷新需要等待子线程任务执行完成。
...
```
  ...
  - 网络请求耗时过长         可参考**网络请求耗时长**中的优化建议。

  - 系统接口请求耗时长         点击系统接口链接，跳转至系统接口请求耗时长的代码部分。比如获取位置信息接口中，页面上位置信息刷新依赖于接口的返回结果。当系统接口响应较慢时，会导致主线程阻塞。
...
```
  ...
  - 主线程在等待setTimeout         点击主线程在等待setTimeout链接，跳转至setTimeout函数代码，可发现主线程中的UI刷新需要等待setTimeout执行完成。
...
3. 可参考优化建议中的文章，来对主线程长时间被阻塞导致完成时延不达标的问题进行优化。  
    ...
    ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-013.png)
...
1. 获得检测结果。点击详情报告中的“点击完成时延”，可以查看图片大纹理的检测结果。  
    ...
    ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-014.png "点击放大")
...
1. 搜索"H:DispatchTouchEvent"标签，找到type=1的那个DispatchTouchEvent，就是点击离手起点，将该时间戳设为起点。  
  ...
  **图4** 确认Trace起点  ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-015.png "点击放大")
  

2. 点击操作完成时延的终点位置在泳道图中没有明确的Trace点，需要通过录屏工具计算出完成时延的耗时时间。从起点往后拉相同的时间找到终点位置。  

  **图5** 确认Trace终点  ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-016.png "点击放大")
...
**图6** ArkTS Callstack泳道图  ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-017.png "点击放大")
...
**图7** ArkTS Callstack泳道耗时函数详情  ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-018.png "点击放大")
...
**图8** 超长帧Trace信息  ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-019.png "点击放大")
...
**图9** Callstack主线程泳道图  ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-020.png "点击放大")
...
**图10** ArkUI Component泳道泳道图  ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-021.png "点击放大")
...
**图11** ArkUI Component泳道图Details信息  ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-022.png "点击放大")
...
**图12** H:Animator 泳道图  ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-023.png "点击放大")
...
![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-024.png "点击放大")
...
![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-025.png "点击放大")
...
![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-026.png "点击放大")
...
![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-027.png "点击放大")
...
| --- | --- |
| ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-028.gif "点击放大") | ![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-029.gif "点击放大") |
...
![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-030.png "点击放大")
...
![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-031.png "点击放大")
...
![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-032.png "点击放大")
...
![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-033.png "点击放大")
...
![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-034.png "点击放大")
...
![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-035.png "点击放大")
...
![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-036.png "点击放大")
...
![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-037.png "点击放大")
...
![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-038.png "点击放大")



查看Runnable详情中的WakeUP From Tid，可发现此刻Running的线程是主线程的唤醒的，将该子线程泳道收藏，并通过跳转按钮找到主线程唤醒该子线程的位置。![](../assets/0012-点击完成时延分析-bpta-click-to-complete-delay-analysis-image-039.png "点击放大")
