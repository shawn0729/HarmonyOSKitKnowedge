...
![](../assets/0020-分析ArkTS-JS内存-bpta-arkts-js-memory-analysis-image-001.png "点击放大")
...
![](../assets/0020-分析ArkTS-JS内存-bpta-arkts-js-memory-analysis-image-002.png "点击放大")
...
![](../assets/0020-分析ArkTS-JS内存-bpta-arkts-js-memory-analysis-image-003.png "点击放大")
...
3. 应用进行多次操作（最好是7次或11次这种特殊的次数），操作完后退回到初始的页面，再次拍摄一次内存快照；
  **图3** snapshot comparison特定场景对象抓取  ![](../assets/0020-分析ArkTS-JS内存-bpta-arkts-js-memory-analysis-image-004.png "点击放大")
...
**图4** **快照对比页面概览**  ![](../assets/0020-分析ArkTS-JS内存-bpta-arkts-js-memory-analysis-image-005.png "点击放大")
...
![](../assets/0020-分析ArkTS-JS内存-bpta-arkts-js-memory-analysis-image-006.png "点击放大")
