 ...
 **图1** 10000条数据量下ForEach和LazyForEach最佳实践启动对比   ![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-001.gif "点击放大")





 **图2** 10000条数据量下ForEach和LazyForEach最佳实践滑动对比   ![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-002.gif "点击放大")
 ...
 **图3** ForEach渲染过程示意图   ![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-003.png "点击放大")
...
![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-004.png "点击放大")
...
| <br>渲染接口 | <br>选型原则 |
| --- | --- |
| <br>ForEach | <br>列表数据较少，数据一次性全量加载不是性能瓶颈时。ForEach相对LazyForEach，代码简单很多。 |
| <br>LazyForEach | <br>列表数据较长，一次性加载所有的列表数据创建、渲染页面产生性能瓶颈时。 |
...
详细的使用规则可以参考ForEach的[使用建议](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-foreach#%E4%BD%BF%E7%94%A8%E5%BB%BA%E8%AE%AE)和LazyForEach的[使用限制](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-lazyforeach#%E4%BD%BF%E7%94%A8%E9%99%90%E5%88%B6)。
...
| --- | --- | --- | --- | --- |
| <br>完全显示所用时间 | <br>1s741ms | <br>1s786ms | <br>1s942ms | <br>5s841ms |
...
| --- | --- | --- | --- | --- |
| <br>完全显示所用时间 | <br>1s544ms | <br>1s572ms | <br>1s652ms | <br>1s707ms |
...
![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-005.png "点击放大")
 ...
 **图6** 缓存作用区域与渲染过程示意图   ![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-006.png)
...
![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-007.png "点击放大")
...
![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-008.png "点击放大")
...
| <br>**cachedCount=5** | <br>**cachedCount=40** | <br>**动态预加载** |
| --- | --- | --- |
| <br>![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-009.gif "点击放大") | <br>![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-010.gif "点击放大") | <br>![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-011.gif "点击放大") |
...
| <br>数据设置 | <br>首屏加载 | <br>滑动过程滑块数量 |
| --- | --- | --- |
| <br>cachedCount=5 | <br>首屏加载快 | <br>滑动过程中白块很多 |
| <br>cachedCount=40 | <br>首屏加载慢 | <br>滑动过程中没有白块或很少 |
| <br>动态预加载 | <br>首屏加载快 | <br>滑动过程中没有白块或很少 |
...
![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-012.png "点击放大")
...
![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-013.png "点击放大")
...
![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-014.png "点击放大")
...
| <br>数据设置 | <br>CPU占比 |
| --- | --- |
| <br>cachedCount=5 | <br>3.96% |
| <br>cachedCount=40 | <br>5.04% |
| <br>动态预加载 | <br>4.12% |
...
![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-015.png "点击放大")
...
![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-016.png "点击放大")
...
![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-017.png "点击放大")
...
| <br>数据设置 | <br>首屏加载时长 |
| --- | --- |
| <br>cachedCount=5 | <br>530.4ms |
| <br>cachedCount=40 | <br>1.8s |
| <br>动态预加载 | <br>545.5ms |
...
![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-018.png "点击放大")
...
需要注意的是复用组件中有@Builder自定义构建函数时，状态变量推荐使用[按引用传递](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-builder#%E6%8C%89%E5%BC%95%E7%94%A8%E4%BC%A0%E9%80%92%E5%8F%82%E6%95%B0)。@Builder装饰的函数默认按值传递，当传递的参数为状态变量时，状态变量的改变不会引起@Builder方法内的UI刷新。
...
![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-019.png "点击放大")
 ...
 **图17** 丢帧耗时分析   ![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-020.png "点击放大")



 **图18** 对丢帧部分的放大分析（整体耗时13.430ms）

![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-021.png "点击放大")
...
![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-022.png "点击放大")
...
![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-023.png "点击放大")
 ...
 **图21** 布局优化前后的层级变化   ![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-024.png "点击放大")
 ...
 **图22** 额外嵌套后的布局层级   ![](../assets/0043-长列表加载丢帧优化-bpta-best-practices-long-list-image-025.png "点击放大")
...
| <br>布局 | <br>相对布局（2层） | <br>线性布局（5层） | <br>额外嵌套的线性布局（25层） |
| --- | --- | --- | --- |
| <br>独占内存 | <br>78.4MB | <br>80.1MB | <br>153.7MB |
| <br>丢帧率 | <br>0% | <br>0% | <br>2.3% |
...
| <br>性能指标 | <br>ForEach | <br>LazyForEach | <br>缓存列表项 | <br>组件复用后 | <br>布局优化后 |
| --- | --- | --- | --- | --- | --- |
| <br>完全显示所用时间 | <br>5s841ms | <br>1s707ms | <br>1s658ms | <br>1s564ms | <br>1s339ms |
| <br>丢帧率 | <br>58.2% | <br>6.6% | <br>3.7% | <br>0.0% | <br>0.0% |
| <br>独占内存 | <br>560.1MB | <br>82.9MB | <br>81.7MB | <br>80.1MB | <br>78.4MB |
