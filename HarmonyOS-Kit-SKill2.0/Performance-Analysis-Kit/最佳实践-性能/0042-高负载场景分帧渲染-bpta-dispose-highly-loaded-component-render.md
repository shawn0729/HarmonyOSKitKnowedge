...
![](../assets/0042-高负载场景分帧渲染-bpta-dispose-highly-loaded-component-render-image-001.png)
...
- [if更新机制](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-ifelse#%E6%9B%B4%E6%96%B0%E6%9C%BA%E5%88%B6)是根据状态判断条件，如果分支没有变化，不会对条件渲染语句进行更新。
- [ForEach非首次渲染](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-foreach#%E9%9D%9E%E9%A6%96%E6%AC%A1%E6%B8%B2%E6%9F%93)会检查新生成的键值是否在上次渲染中已经存在。如果键值不存在，则会创建一个新的组件；如果键值存在，则不会创建新的组件，而是直接渲染该键值所对应的组件。
...
![](../assets/0042-高负载场景分帧渲染-bpta-dispose-highly-loaded-component-render-image-002.png)
...
![](../assets/0042-高负载场景分帧渲染-bpta-dispose-highly-loaded-component-render-image-003.png "点击放大")
...
![](../assets/0042-高负载场景分帧渲染-bpta-dispose-highly-loaded-component-render-image-004.gif "点击放大")
...
![](../assets/0042-高负载场景分帧渲染-bpta-dispose-highly-loaded-component-render-image-005.png)
...
![](../assets/0042-高负载场景分帧渲染-bpta-dispose-highly-loaded-component-render-image-006.png "点击放大")
...
![](../assets/0042-高负载场景分帧渲染-bpta-dispose-highly-loaded-component-render-image-007.png "点击放大")
...
![](../assets/0042-高负载场景分帧渲染-bpta-dispose-highly-loaded-component-render-image-008.gif "点击放大")
...
![](../assets/0042-高负载场景分帧渲染-bpta-dispose-highly-loaded-component-render-image-009.png "点击放大")
...
![](../assets/0042-高负载场景分帧渲染-bpta-dispose-highly-loaded-component-render-image-010.png "点击放大")
...
![](../assets/0042-高负载场景分帧渲染-bpta-dispose-highly-loaded-component-render-image-011.png "点击放大")
...
![](../assets/0042-高负载场景分帧渲染-bpta-dispose-highly-loaded-component-render-image-012.png "点击放大")
