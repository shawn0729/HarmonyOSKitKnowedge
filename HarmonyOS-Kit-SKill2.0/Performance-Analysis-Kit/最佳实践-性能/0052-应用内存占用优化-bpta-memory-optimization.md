...
**图1** LRUCache的LinkedHashMap数据结构图  ![](../assets/0052-应用内存占用优化-bpta-memory-optimization-image-001.png "点击放大")
...
**图2** Purgeable内存访问流程图  ![](../assets/0052-应用内存占用优化-bpta-memory-optimization-image-002.png)
...
**图3** Purgeable内存回收流程图  ![](../assets/0052-应用内存占用优化-bpta-memory-optimization-image-003.png)
...
![](../assets/0052-应用内存占用优化-bpta-memory-optimization-image-004.png "点击放大")
...
![](../assets/0052-应用内存占用优化-bpta-memory-optimization-image-005.png "点击放大")
