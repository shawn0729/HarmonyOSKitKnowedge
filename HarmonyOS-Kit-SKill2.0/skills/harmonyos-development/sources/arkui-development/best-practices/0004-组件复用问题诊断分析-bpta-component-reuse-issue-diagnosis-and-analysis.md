...
2. 本文展示的[正反例代码](https://gitcode.com/harmonyos_samples/BestPracticeSnippets/tree/master/ComponentReuse)分别位于positive和negative模块中，检测时需选择相应模块。     ![](../../_assets/images/8a15cce0d49a4ebfa782189a.webp "点击放大")

3. 点击工具“手动性能页面滑动体检”，按照提示进行检测操作。     ![](../../_assets/images/2140e1ce8b5df152e870558c.webp "点击放大")

4. 通过分析检测结果，结合滑动过程中列表卡片的创建次数，可以分析出当前列表的组件未使用复用或者复用未生效。     ![](../../_assets/images/0c524c8a6a664be807a1e19c.webp "点击放大")
...
- **场景一：****列表项结构类型相同**     ListItem的根组件只有一个，且根组件整体结构组成不变。
     ...
     ![](../../_assets/images/395ad4539bd807bded591a9d.webp "点击放大")
...
- **场景二：****列表项结构类型不同**     **①"总-分式"子组件可变结构**：ListItem的根组件只有一个，且根组件整体结构组成不变，局部子组件进行替换。
     ...
     ![](../../_assets/images/eafc9fdd113e170b214ef705.webp "点击放大")
...
```
  [NoComponentReuseSceneTwoPositiveExample.ets](https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/ComponentReuse/entry/src/main/ets/view/NoComponentReuseSceneTwoPositiveExample.ets#L26-L55)
     ...
     **②分类组合式结构**：ListItem的根组件有多种类型，不同类型的根组件布局组成不同。
     ...
     ![](../../_assets/images/76a68c60c844242e14673310.webp "点击放大")
...
- **场景三****：****列表项内子组件可拆分组合**     ListItem没有根组件，通过不同子组件相互组合，形成多种布局形态。
     ...
     ![](../../_assets/images/6e9e3aef69958e643cd062ef.webp "点击放大")
...
- **场景一：父组件未使用复用，子组件使用复用**     ![](../../_assets/images/a5a68460955bbf6e985106a4.webp "点击放大")
...
- **场景二：复用嵌套**     ![](../../_assets/images/51ee1a96a1f70c73489b7dcd.webp "点击放大")
...
- **场景三：****reuseId分类过粗**     ![](../../_assets/images/9a0364b70a165217e07f8b36.webp "点击放大")
...
![](../../_assets/images/12c36936efa28faa8b6658d3.webp "点击放大")
...
![](../../_assets/images/4551bf1d47961eb746cbdc6b.webp "点击放大")
...
![](../../_assets/images/5d98e073f14bf9b808308493.webp "点击放大")
