...
**图1** 场景动画  ![](../../_assets/images/4ec9afc48ea2a078d986e9c6.webp "点击放大")
...
![](../../_assets/images/77a39bdafee8d7434a376045.webp "点击放大")
...
1. 确认起点：如果是由点击触发，则首先定位到应用侧的DispatchTouchEvent，如下图虚线所示：
  **图3** Trace起点     ![](../../_assets/images/5b5548ce451cdad315f19303.webp "点击放大")
...
2. 确认终点：选择连续稳定发出的第一帧vsync信号作为终点，而非不稳定vsync信号，是因为非连续的vsync信号不一定触发界面上的渲染行为。本文旨在分析从应用元素点击到应用界面开始变化的点击时延问题，因此选择连续稳定渲染的第一帧vsync信号作为终点。
  **图4** Trace终点     ![](../../_assets/images/4170fabdc31758cb66b84165.webp "点击放大")

     从图中可以看出，后续动画已经达到最大帧率，说明无响应发生在图中区域内。

3. 分析中途出现的H:ReceiveVsync信号可以发现，在无响应阶段出现了几帧，但每帧的耗时并不长。应用侧也是如此，说明在UI绘制过程中没有高负载。
  **图5** Trace帧率分析     ![](../../_assets/images/e499a56a04c8fbb916d211af.webp "点击放大")

4. 在此过程中，应用长时间占用CPU，原因可能是进行了大量的计算。
  **图6** 可能耗时原因
     ![](../../_assets/images/3f428262d90f3e631a39492a.webp "点击放大")
...
**图7** DevTools泳道图区域划分  ![](../../_assets/images/c762e05263450dda8f2f0c78.webp "点击放大")
...
**图8** DevTools泳道图区域划分  ![](../../_assets/images/c762e05263450dda8f2f0c78.webp "点击放大")
...
**图9** DevTools泳道图区域划分  ![](../../_assets/images/c762e05263450dda8f2f0c78.webp "点击放大")
...
**图10** DevTools泳道图区域划分  ![](../../_assets/images/7cb104807fad3b346e95fbbd.webp "点击放大")
...
![](../../_assets/images/c7999ae4caef9e4fd6a2e0b8.webp "点击放大")
...
**图12** DevTools泳道图区域划分  ![](../../_assets/images/c762e05263450dda8f2f0c78.webp "点击放大")
...
**图13** DevTools泳道图区域划分  ![](../../_assets/images/c762e05263450dda8f2f0c78.webp "点击放大")
...
**图14** DevTools泳道图区域划分  ![](../../_assets/images/c762e05263450dda8f2f0c78.webp "点击放大")
...
**图15** 优化后的泳道图  ![](../../_assets/images/a183f384ff3b2a26a3dbda88.webp "点击放大")
