 ...
 **图1** 点击响应起止点示意图   ![](../../_assets/images/d304e158bc9b0f7fb5394673.webp "点击放大")
...
![](../../_assets/images/453fa6c9170bd806ecd03741.webp "点击放大")
...
3. 开发者需根据提示，在应用中找到待检测页面，点击工具中的开始按钮，然后在应用中手动执行转场，操作后点击停止完成本次检测。  
     ...
     ![](../../_assets/images/c48498ceaa444ad0421c9fae.webp "点击放大")

  

4. 检测结果分析，点击响应时延应小于或等于100ms。图中存在大于100ms的点击响应时延，判断为存在性能问题。  

     ![](../../_assets/images/d80eecb33ff7a2918dc1d4ab.webp "点击放大")
...
1. 获得检测结果后，点击详情报告中的“点击响应时延”，可以查看UI线程应用自身方法耗时长的检测结果。  
     ...
     ![](../../_assets/images/a9a3024cd49ffa3b9b3412d0.webp "点击放大")
...
1. 获得检测结果后，点击详情报告中的“点击响应时延”，可以查看UI线程应用自定义组件创建耗时检测结果。  
     ...
     ![](../../_assets/images/75ee84215e1d2c5aa3c65e43.webp "点击放大")

  

2. 可点击源文件定位到创建耗时的UI组件，根据提供的可能故障原因，去对UI组件进行相应优化修改，减少该UI组件自身创建耗时。  

     ![](../../_assets/images/0bb9e76fac4e27755b5f0af9.webp "点击放大")
...
1. 抓取操作trace：启动DevEco Studio，连接设备，打开应用，执行以下操作。  
  ...
  5. 点击Frame模板框中的播放按钮开始录制，操作应用界面进行点击响应，完成后点击结束录制。
     ...
     ![](../../_assets/images/e70409e5afd2a23db9e5c9aa.webp "点击放大")
...
3. 分解时间段：点击响应的整体时延拆解后，主要分为输入阶段、应用阶段和渲染阶段。  
  ...
  展开
    ...
    | <br>渲染阶段 | <br>对应的RS帧ProcessCommandUni起点 | <br>对应的RSHardwareThread::CommitAndReleaseLayers的结束点 | <br>20 |
     ...
     ![](../../_assets/images/eaccf6c2e6fcd9d274773e39.webp "点击放大")
...
4. 分析定位原因：针对框选的应用阶段，分析主进程泳道，观察是否存在耗时长的函数阻塞主线程或超长耗时单帧。如果有长段的ExecuteJs，查看具体的调用栈或火焰图，定位耗时函数。如果是FlushLayoutTask阶段耗时，结合UI组件树分析布局合理性，查找优化空间。  
     ...
     ![](../../_assets/images/6a65ef9896b612f1b04e48f2.webp "点击放大")
 ...
 **图3** renderGroup使用场景示例   ![](../../_assets/images/6fd26360ad62021a05d1a701.webp)
 ...
 **图4** 生命周期流程图   ![](../../_assets/images/f06bcc90aa989ad720aedced.webp "点击放大")
 ...
 **图5** 应用响应的两个视角   ![](../../_assets/images/1b81dc53ec5e20ad6f6882fd.webp)
