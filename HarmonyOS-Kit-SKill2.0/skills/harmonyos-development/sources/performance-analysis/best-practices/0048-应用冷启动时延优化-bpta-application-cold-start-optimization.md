...
![](../../_assets/images/cb98ca9bf8faad36d457c152.webp "点击放大")
...
1. 选择entry模块，暂时关闭模块build-profile中的混淆开关。     ![](../../_assets/images/fe6f3e3028ea6b481ed0eb2a.webp "点击放大")

2. 检查一下build模式，改为release。     ![](../../_assets/images/15fdcaedebe94e70c9d07da0.webp)

3. 点击菜单 -> tool -> AppAnalyzer，打开体检工具。

4. 选择“场景化体检”，点击“手动性能冷启动体检”。     工具开始准备，会自动编译、安装、运行当前工程，此时需要“保持手机解锁状态”，当准备完成后，会提示点击开始按钮，开始体检。

     ![](../../_assets/images/7a79fc61daa81683de110725.webp "点击放大")
...
![](../../_assets/images/acbe1597d4bfae3851154a24.webp "点击放大")
...
![](../../_assets/images/089a975446333b33d1455f3e.webp "点击放大")
...
![](../../_assets/images/ba46c2e16d814c8429362a46.webp "点击放大")
...
![](../../_assets/images/61ae7f438282a94f90606d9d.webp "点击放大")
...
```
  ...
  - 如果上层文件为其他module的统一对外暴露接口文件（例如Index.ets），则需要通过import路径展开性能优化。         例如CustomLayout1上层模块为library模块的Index.ets，其中有多个文件导出。
         ...
         ![](../../_assets/images/85bb62623043f5adc221c260.webp "点击放大")
...
5. 在导出文件中标记已修改的文件。     在下载全量import文件清单表格中，标记已优化的未使用文件，便于优化备忘，特别是当需要优化的文件比较多的时候。
     ...
     ![](../../_assets/images/d7e8cd76d407be98375a7da6.webp "点击放大")
...
- 网络请求本身耗时长     ![](../../_assets/images/f001d5a6e1cbb29b0af6b019.webp "点击放大")
...
- 网络请求发起太晚     ![](../../_assets/images/8f02de38740107102fb5bcac.webp "点击放大")
...
![](../../_assets/images/5aefa2c80ef587515d8327cc.webp "点击放大")
...
![](../../_assets/images/e5485a84219976b958ccfbbb.webp "点击放大")
...
![](../../_assets/images/9b3fb0ca23b1237698d773d7.webp "点击放大")
...
![](../../_assets/images/e1eeecea83c88dac90103662.webp "点击放大")
...
![](../../_assets/images/a52eac1956d21c3ce0b38881.webp "点击放大")
...
![](../../_assets/images/a190a5678acb372991f55e1c.webp "点击放大")
...
![](../../_assets/images/a8c87a4ef79e07454e697823.webp "点击放大")
...
![](../../_assets/images/7e9518ef704ed2e96f509d51.webp "点击放大")
...
![](../../_assets/images/74819392ce55a09cbd4ae950.webp "点击放大")
...
![](../../_assets/images/ccae909c0f3cb3a68e835fda.webp "点击放大")
...
![](../../_assets/images/46c90f8175767845e8dc8662.webp "点击放大")
...
![](../../_assets/images/7f26e8b7585afb19c81f96b6.webp "点击放大")
 ...
 **图4** 优化网络请求时机前   ![](../../_assets/images/36ebed52121fe80b4e8752a1.webp "点击放大")



 **图5** 优化网络请求时机后   ![](../../_assets/images/696088cc6d8bbd873cc91fa5.webp "点击放大")
 ...
 **图6** 优化前使用4096px-4096px启动页图标应用启动耗时   ![](../../_assets/images/5d4685c32f5b6fd97d00af68.webp)



 **图7** 优化后使用144px-144px启动页图标应用启动耗时   ![](../../_assets/images/565ce54768d0b55c2cd24068.webp)
 ...
 **图8** 优化前import 15个模块   ![](../../_assets/images/dc655f2c1cc1044291786012.webp "点击放大")



 **图9** 优化后import 5个模块   ![](../../_assets/images/97bca4bce835a93767ab5caa.webp "点击放大")
...
- 减少使用嵌套的export *方式进行全量导出     在应用冷启动过程中，`HandleLaunchAbility` 会执行冷启动相关的 `.ets` 文件。所有被主页面import的 `.ets` 文件均会被执行，包括数据结构、变量和全局函数的初始化。首页所需的变量和函数可能来自其他 `.ets` 文件，并通过export形式提供给首页使用。详细信息请参见[减少同文件大量export *导出方式](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-arkts-high-performance#section1218510102815)。
   ...
   **图10** （优化前）存在8层嵌套export *   ![](../../_assets/images/b32cd78f74cf82e358e4e402.webp "点击放大")

   **图11** （优化后）不存在嵌套export *，从目标文件中直接import   ![](../../_assets/images/f3fe885f93a2e9a8eced26fc.webp "点击放大")
     对比数据如下：
...
- 减少import *的方式全量引用     应用程序加载时，通常将相同类型的变量或函数放在同一个工具类文件中。使用时，通过import方式引入对应的模块。当工具类中存在较多暴露的函数或变量时，推荐按需引用具体的变量，以减少 `.ets` 文件的执行耗时和文件中所有export变量的初始化过程。详情请参见[减少同文件大量export *导出方式](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-arkts-high-performance#section1218510102815)。
   ...
   **图12** 优化前，使用import * as nm全量引用2000条数据   ![](../../_assets/images/c3677e59fc96f197ada9035f.webp "点击放大")

   **图13** 优化后，使用import { One }按需引用   ![](../../_assets/images/4a0253ac786570e93b8b7053.webp "点击放大")
     优化前后的对比数据如下：
...
![](../../_assets/images/09756cb8f514d19b6fba56cd.webp "点击放大")
...
![](../../_assets/images/239306b0d41bc764ad0f20ec.webp "点击放大")
...
![](../../_assets/images/6330cfdaa8580e23291f2d4c.webp "点击放大")
 ...
 **图17** 优化前：加载模块时执行了非冷启动相关文件   ![](../../_assets/images/f68365da344a93b7e655c3bb.webp "点击放大")



 **图18** 优化方案一：拆分HAR导出文件   ![](../../_assets/images/ab4833ebe5ee03c35de9a555.webp "点击放大")



 **图19** 优化方案二：导入冷启动文件时全路径展开   ![](../../_assets/images/42859ad722b4d9366b0a694f.webp "点击放大")
 ...
 **图20** HAP+20个HSP混合打包   ![](../../_assets/images/b9cc15abb6c11ebbe2753ea3.webp "点击放大")



 **图21** 将20个HSP包设计成HAR包   ![](../../_assets/images/63bcc29adbd8671b73d8acab.webp "点击放大")
 ...
 **图22** 优化前同步执行操作（computeTask），应用冷启动耗时   ![](../../_assets/images/bf493c736047bd98f7ce95d6.webp)



 **图23** 优化后异步执行操作（computeTaskAsync），应用冷启动耗时   ![](../../_assets/images/3e2b14e391c9c9a48bfc5478.webp)
...
![](../../_assets/images/b724686b52c95ab28af83a87.webp "点击放大")
 ...
 **图25** 优化前同步执行操作（computeTask），应用冷启动耗时   ![](../../_assets/images/7d3aba761d98ca4bf3064b7c.webp)



 **图26** 优化后异步执行操作（computeTaskAsync），应用冷启动耗时   ![](../../_assets/images/00ec3fb1220ec0f4d284638f.webp)
...
![](../../_assets/images/befda690f97b686036e9c822.webp "点击放大")
 ...
 **图28** 优化前同步执行操作（computeTask），应用冷启动耗时   ![](../../_assets/images/7a8f6148fbfbea8c1f32900e.webp)



 **图29** 优化后异步执行操作（computeTaskAsync），应用冷启动耗时   ![](../../_assets/images/1905b3c602f2f4ac2b4ec982.webp "点击放大")
...
![](../../_assets/images/2d6bbc0f9928bf70a65dca31.webp "点击放大")
 ...
 **图31** 优化前未使用本地存储数据   ![](../../_assets/images/f0a5f4acf1e349d46f098822.webp "点击放大")



 **图32** 优化后使用本地存储数据   ![](../../_assets/images/9a4db878256a9c976d65659b.webp "点击放大")
