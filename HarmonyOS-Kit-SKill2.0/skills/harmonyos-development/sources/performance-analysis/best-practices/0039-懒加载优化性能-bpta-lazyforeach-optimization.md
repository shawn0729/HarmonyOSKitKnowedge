...
- 循环渲染     ForEach循环渲染的过程如下：
   ...
   **图1** ForEach渲染过程示意图   ![](../../_assets/images/b1bbe4ac31ac943ca0a9601e.webp "点击放大")
...
2. 通过Profiler调优工具抓取Trace，可以判断子组件创建的次数。如下图所示，在该帧中出现大量的BuildLazyItem切片，每一次BuildLazyItem对应一次子组件的创建，对比数量可知LazyForEach按需加载失效。关于调优的内容可参考[性能分析](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-optimization-tool-practice)。     ![](../../_assets/images/ac8823bb58bd50d2526baaf9.webp "点击放大")
