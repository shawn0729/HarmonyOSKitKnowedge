...
![](../assets/0002-应用后台运行-bpta-back-task-implement-image-001.png "点击放大")
...
![](../assets/0002-应用后台运行-bpta-back-task-implement-image-002.png "点击放大")
...
- **系统息屏场景/应用置于后台场景：**前台应用在自动息屏后，会被识别为置于后台。此时，应用可以申请短时任务，剩余时长上限为3分钟（如下图所示，delayTime为18000ms）。![](../assets/0002-应用后台运行-bpta-back-task-implement-image-003.png)
- 当短时任务的剩余时间不足时，系统会触发回调，停止任务。![](../assets/0002-应用后台运行-bpta-back-task-implement-image-004.png)
...
![](../assets/0002-应用后台运行-bpta-back-task-implement-image-005.png "点击放大")
...
- 在定位和导航应用场景中，应用前台运行时开启位置订阅，控制台定期打印位置信息。![](../assets/0002-应用后台运行-bpta-back-task-implement-image-006.png)


- 在定位和导航应用场景中，应用退至后台持续运行，控制台日志定时打印位置信息。![](../assets/0002-应用后台运行-bpta-back-task-implement-image-007.png)
