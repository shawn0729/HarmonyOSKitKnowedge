...
- [全屏播放视频](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-video-adaptation-based-web#section6164167185112)：默认情况下视频点击全屏播放后，会以竖屏的形式进行播放，导致视频画面较小影响用户体验，通过适配全屏播放视频，可以让用户拥有更好的视频观看体验。
...
**图1** 默认情况下进入视频全屏播放效果  ![](../assets/0002-Web页面视频适配-bpta-video-adaptation-based-web-image-001.gif "点击放大")



### 实现原理

**图2** Web页面适配全屏播放视频流程图  ![](../assets/0002-Web页面视频适配-bpta-video-adaptation-based-web-image-002.png "点击放大")
...
**图3** Web页面适配全屏播放效果  ![](../assets/0002-Web页面视频适配-bpta-video-adaptation-based-web-image-003.gif "点击放大")
...
**图4** 长按复制视频链接地址效果图  ![](../assets/0002-Web页面视频适配-bpta-video-adaptation-based-web-image-004.gif "点击放大")
...
**图5** 长按下载视频整体适配流程图  ![](../assets/0002-Web页面视频适配-bpta-video-adaptation-based-web-image-005.png "点击放大")
...
**图6** 长按下载视频效果图  ![](../assets/0002-Web页面视频适配-bpta-video-adaptation-based-web-image-006.gif "点击放大")
