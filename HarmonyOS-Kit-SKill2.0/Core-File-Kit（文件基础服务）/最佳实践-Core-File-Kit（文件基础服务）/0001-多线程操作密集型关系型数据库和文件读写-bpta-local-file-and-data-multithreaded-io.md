...
![](../assets/0001-多线程操作密集型关系型数据库和文件读写-bpta-local-file-and-data-multithreaded-io-image-001.png "点击放大")
...
![](../assets/0001-多线程操作密集型关系型数据库和文件读写-bpta-local-file-and-data-multithreaded-io-image-002.png)
