...
**图1** ArkTS侧获取沙箱路径传递给Native侧访问文件示意图  ![](../assets/0002-Native侧实现文件访问-bpta-file-native-side-image-001.png)
...
**图2** ArkTS侧传递沙箱路径到Native侧方案效果展示  ![](../assets/0002-Native侧实现文件访问-bpta-file-native-side-image-002.png "点击放大")



![](../assets/0002-Native侧实现文件访问-bpta-file-native-side-image-003.png)



### 方案二：Native侧直接拼接沙箱路径访问文件

**图3** Native侧直接拼接沙箱路径访问文件示意图  ![](../assets/0002-Native侧实现文件访问-bpta-file-native-side-image-004.png)
...
**图4** Native侧拼接沙箱路径方案效果展示  ![](../assets/0002-Native侧实现文件访问-bpta-file-native-side-image-005.png "点击放大")



![](../assets/0002-Native侧实现文件访问-bpta-file-native-side-image-006.png)
...
**图5** Native侧访问应用资源文件方案示意图  ![](../assets/0002-Native侧实现文件访问-bpta-file-native-side-image-007.png)
...
**图6** ArkTS侧传递resource manager到Native侧方案效果展示  ![](../assets/0002-Native侧实现文件访问-bpta-file-native-side-image-008.png "点击放大")



![](../assets/0002-Native侧实现文件访问-bpta-file-native-side-image-009.png)
...
**图7** Native侧写入公共目录文件场景示意图  ![](../assets/0002-Native侧实现文件访问-bpta-file-native-side-image-010.png)
...
**图8** Native侧写公共目录文件场景方案效果展示  ![](../assets/0002-Native侧实现文件访问-bpta-file-native-side-image-011.png "点击放大")



![](../assets/0002-Native侧实现文件访问-bpta-file-native-side-image-012.png)
...
**图9** Native侧读取公共目录文件场景示意图  ![](../assets/0002-Native侧实现文件访问-bpta-file-native-side-image-013.png)
...
**图10** Native侧读公共目录文件场景方案效果展示  ![](../assets/0002-Native侧实现文件访问-bpta-file-native-side-image-014.png "点击放大")



![](../assets/0002-Native侧实现文件访问-bpta-file-native-side-image-015.png)
